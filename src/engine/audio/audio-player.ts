...
export function getAudioPlayer(): AudioPlayer {
  ...
  (p=1,k=.05,b=220,e=0,r=0,t=.1,q=0,D=1,u=0,y=0,v=0,z=0,l=0,E=0,A=0,F=0,c=0,w=1,m=0,B=0)=>{let
    ...
    r+t+c|0;a<h;k[a++]=f)++J%(100*F|0)||(f=q?q>1?q>2?q>3?M.sin((g%d)**3):M.max(M.min(M.tan(g),1)
    ,-1):1-(2*g/d%2+2)%2:1-4*M.abs(M.round(g/d)-g/d):M.sin(g),f=(l?1-B+B*M.sin(d*a/l):1)*(f>0?1:
